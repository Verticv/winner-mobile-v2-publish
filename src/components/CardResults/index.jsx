                ...
                >
                    <div
                        ...
                        <div className="flex items-center">
                            {hasUp && <img style={{ marginRight: '0.4375rem', width: '10rem', height: '10rem' }} className="object-contain w-8 h-7" src={UpIcon} alt="" />}
                ...
                <button style={{
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            {hasDown && <img style={{ marginLeft: '0.4375rem', width: '10rem' }} className="object-contain w-8 h-7" src={DownIcon} alt="" />}
                        </div>
