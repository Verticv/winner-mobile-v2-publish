    ...
    const SendMessage = ({ placeholder, buttonText }) => {
        return (
            <div style={{ height: "17.4375rem", borderRadius: "1.625rem", marginTop: '-0.4rem', fontSize: '2.8125rem', borderWidth: '0.1875rem', display: 'flex', position: 'relative' }} className="relative flex w-full bg-white border border-gray-dddddd overflow-hidden">
                ...
                <textarea
                    style={{ border: '0', width: "60.9375rem", padding: '3.3rem 4rem 3.5625rem 3.89rem', resize: "none", lineHeight: '1.32', WebkitTextStroke: "0.2px", borderRadius: '1rem', background: '#272726' }}
                ...
                <button style={{ borderRadius: "0.625rem", width: '10.5625rem', padding: '0.1875rem', position: 'absolute', right: 2, height: '99%', background: 'linear-gradient(to top, #223349, #415a77 50%, #5e7fa4 )' }} className="right-0 absolute flex items-center justify-center h-full bg-blue-r013d74 hover:opacity-75">
    ...
    return (
        <div className="freeboard-view">
            ...
            <div style={{ borderRadius: "1.1875rem", marginTop: '3.75rem', padding: '0.1875rem', background: 'linear-gradient(to top,#1f1f1e, #383838 50%, #4a4a4a )' }} className="w-full bg-gray-fafafa shadow-subNavbar">
                <div style={{ width: '100%', height: '100%', background: 'blue', borderRadius: '1.1875rem' }}>
