...
const Contact = ({ subActiveButton, setSubActiveButton }) => {
    ...
    const tabsArray = [
        ...
        { text: "키론가상게임 ", width: '20.3125rem', id: 7, path: "/cscenter/all/contact/all/ar-game", additionLeftScroll: -200 },
        { text: "피싱게임 ", width: '20.3125rem', id: 8, path: "/cscenter/all/contact/all/ar-game1", additionLeftScroll: -200 },
