...
const subTabsArray = [
    ...
    { text: "전체", icon: Icon0, id: 0, marginIcon: '', width: '19.375rem', path: '#' },
    { text: "마이크로게이밍", icon: Icon1, id: 1, width: '19.375rem', path: '#' },
    { text: "YGG드라실", icon: Icon2, id: 2, width: '19.375rem', path: '#' },
    { text: "드라군소프트", icon: Icon3, id: 3, width: '19.375rem', path: '#' },
    { text: "분고", icon: Icon4, id: 4, custom: "mt-8px", width: '19.375rem', path: '#' },
    { text: "플레이슨", icon: Icon5, id: 5, width: '19.375rem', path: '#' },
    { text: "넷엔트", icon: Icon6, id: 6, width: '19.375rem', path: '#' },
    { text: "프레그메틱플레이", icon: Icon7, id: 7, width: '19.375rem', path: '#' },
    { text: "퀵스핀", icon: Icon8, id: 8, width: '19.375rem', path: '#' },
