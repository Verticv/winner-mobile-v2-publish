            ...
            <div style={{ margin: '3.75rem 1.875rem', marginTop: '1.875rem', marginBottom: '2.5rem' }} className="flex items-center justify-between flex-shrink-0">
                <div className="flex w-full" style={{ display: 'flex' }}>
                    ...
                    >
                        ...
                        >
                            <span style={{ fontSize: '2.8125rem', color: 'rgb(255, 223, 189)', marginLeft: '0.3rem' }} className="font-spoqaMedium tracking-tight text-14px text-white mb-2">{isAllSelected ? "선택해제" : "전체선택"}</span>
                        </div>
                    </button>
                    <button
                        style={{
                    ...
                    >
                        ...
                        >
                            <span style={{ fontSize: '2.8125rem', color: 'rgb(255, 223, 189)', marginLeft: '0.3rem' }} className="font-spoqaMedium tracking-tight text-14px text-white pb-2">{btn1Text}</span>
                        </div>
                    </button>
                    <button
                        style={{
                    ...
                    >
                        ...
                        >
                            <span style={{ fontSize: '2.8125rem', color: 'rgb(255, 223, 189)', marginLeft: '0.3rem' }} className="font-spoqaMedium tracking-tight text-14px text-white pb-2">{btn2Text}</span>
                        </div>
                    </button>
                </div >
            </div >
