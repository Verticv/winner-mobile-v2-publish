...
const TableHeader = ({ smallCard = false, isMinigame = false, middleText = "무" }) => {
    ...
    if (isMinigame === true) return (
        <div style={{ paddingTop: '1.5625rem', paddingBottom: '1.375rem',  display: 'flex', justifyContent: 'right', alignItems: 'center', paddingRight: '1.8rem', letterSpacing: '-0.07rem', color: 'rgb(204, 194, 182)', fontFamily: 'SpoqaHanSansNeoMedium' }} className="flex w-full pb-8 font-spoqaMedium text-14px tracking-tight text-gray-r454545">
        ...
        <div style={{ paddingTop: '1.69rem', paddingBottom: '1.375rem', display: 'flex', justifyContent: 'right', alignItems: 'center', paddingRight: '1.8rem', letterSpacing: '-0.07rem', color: 'rgb(204, 194, 182)', fontFamily: 'SpoqaHanSansNeoMedium' }} className="flex w-full pb-8 font-spoqaMedium text-14px tracking-tight text-gray-r454545">
            <div style={{ fontSize: '2.625rem', marginLeft: smallCard ? '' : '12rem' }} className="h-full flex items-center justify-end">승(홈)</div>
            ...
            <div style={{ fontSize: '2.625rem', marginLeft: smallCard ? '12.4rem' : '13.2rem' }} className="h-full flex items-center justify-end">패(원정)</div>
