...
const CouponGiftPopupTable = () => {
    ...
    return (
        <div style={{ borderRadius: "1.2rem", overflowY: 'scroll', background: '#323232', height: '73.6rem', boxShadow: '0px 6px 12px 0px rgba(0, 0, 0, 0.6)' }} className="shadow-subNavbar overflow-y-scroll h-full">
            <div style={{ height: '6.7rem', color: '#ccc2b6', fontFamily: 'SpoqaHanSansNeoMedium', letterSpacing: '-0.07rem', paddingTop: '1.7rem', paddingRight: '' }} className="bg-gray-fafafa font-spoqaMedium w-full tracking-tight text-gray-r585858 border-b border-gray-dddddd flex items-center">
