        ...
        <div style={{ backgroundColor: "#2b2b2a", height: "", marginTop: '1.5rem', borderRadius: '0.5rem' }} className="w-full h-full rounded-xl p-20px">
          ...
          <div className="pt-20px space-y-23px" style={{ padding: '1.8rem', letterSpacing: '-0.06rem' }}>
            ...
            <div className="flex flex-col" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', marginTop: '0.35rem' }}>
              <span style={{ color: "#8c8c8c", fontSize: '2.0625rem', fontFamily: 'SpoqaHanSansNeoMedium' }} className="flex h-16px items-center text-16px tracking-tight font-spoqaMedium ">
