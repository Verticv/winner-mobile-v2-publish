...
import HorizontalSubMenu1 from '../HorizontalSubMenu'
...
const MinigamePolicy = () => {
    ...
    return (
        <div>
            ...
            {console.log('111 >>>>>>>>>>>>>>>>>>>>>>>  /cscenter/all/policy/sportsgame/soccer')}
                <Route path="/cscenter/all/policy/minigame"
                    element={<img src={PowerballPolicy} alt="" />}
                >
            {console.log('2222 minigame >>>>>>>>>>>>>>>>>>>>>>>  /cscenter/all/policy/minigame/')}
