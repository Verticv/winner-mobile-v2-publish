    ...
    return (
        <form style={{ width: '100%' }}>
            ...
            >
                ...
                >
                    <div className={`sort-by-p ${labelClasses} ${ddda ? 'ddda' : ''} `} style={{marginTop: sortValue === "전체회차" && '-0.4rem'}}><p className="placeholder:text-gray-r7b7b7b text-gray-r7b7b7b">{sortValue}</p></div>
                    {children}
